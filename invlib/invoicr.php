  ...
  class Invoicr {
    ...
    // (C) INVOICE DATA
    // (C1) COMPANY HEADER - CHANGE TO YOUR OWN  private $company = [!
    private $company = [
      "church.png", // URL TO COMPANY LOGO, FOR HTML INVOICES
      "D:/http/code-boxx-logo.png", // FILE PATH TO COMPANY LOGO, FOR PDF/DOCX INVOICES
      "<strong>JIMBO KUU KATOLIKI LA DAR ES SALAAM</strong>", 
      "<strong>PAROKIA YA MT YOHANE PAULO WA II, MBEZI MSHIKAMANO</strong>",
      "S.L.P 280 DAR ES SALAAM",
      "E-mail:katolikimshikamano@gmail.com",
      ""
    ];
