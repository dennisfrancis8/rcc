<?php 
    ...
    $query =  "UPDATE `cash_contribution` SET `cashContributionDescription` = '$denialReason',  `dateResponded` = '$today', `cashContributionStatus` = $denied WHERE `cashContributionUid` = $contributionId";
